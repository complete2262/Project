...
//email입력체크
 ...
 //모든 유효한 데이터를 입력했을시 가입버튼 활성화
		  function signupCheck() {
		      ...
		      if(email1 != "" && email2 != "" && major != "" && idCheck == 1 && pwdCheck == 1 && nNamecheck ==1) {
...
<body id="bodyheight">
	...
	<div class="container" id="main" style="">
		...
		<div class="row" id="joininner">
			...
			<div class="col-12">
				<form name="join" class="needs-validation" novalidate=""
					onsubmit="return validate();" action="insert" method="post">
					<div class="row">
						<div class="col-md-6">
							<div class="col-md-12">
								<label for="id2">I D</label> <input type="text" name="user_id"
									required="" class="form-control" id="id" placeholder=""
									maxlength="12" />
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="col-md-10">
								<label for="nickname">NICKNAME</label> <input type="text"
									maxlength="" class="form-control" id="nickname" name="nickName" placeholder=""
									value="" required="">
							</div>
								...
								<div class="input-group">
									<div class="input-group-prepend">
										<input type="text" class="form-control" name="email_id" id="email_id"
											...
											name="email_site" required="" class="custom-select d-block w-100" oninput="emailcheck()">
						...
						<div class="col-md-6">
							<div class="col-md-12">
								<label for="interest">INTEREST MAJOR</label> <select
									class="custom-select d-block w-100" id="major" name="interest" oninput="majorcheck()" required="">
					...
					<div class="row">
						<div class="col-md-12 text-center">
							...
							<button type="submit" class="btn btn-primary" disabled>가입신청</button>
							&nbsp;
						</div>
					</div>
					<div class="col-md-12"></div>
